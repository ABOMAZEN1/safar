...
namespace App\Http\Requests\Api\V1\Auth\Dashboard\TravelCompany;
...
final class TravelCompanyLoginRequest extends BaseApiFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'phone_number' => PhoneNumberRule::make()
                ->exists(UserTypeEnum::TRAVEL_COMPANY)
                ->rules(),
